...
class ProductController extends Controller
{
    public function index() {
        ...
        return view('admin.product', compact('getproduct'));
    }

    public function list()
    {
        $getproduct = Product::all();
        return view('admin_tables.producttable',compact('getproduct'));
    }
    ...
    public function productimages($id) {
        ...
        return view('admin.product-images', compact('getproductimages','productdetails'));
    }

...
<div class="row page-titles mx-0">
    <div class="col p-md-0">
        ...
        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#addProduct" data-whatever="@addProduct">Add New Product</button>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="table-responsive" id="table-display">
                        @include('user_tables.producttable')
                    </div>
                </div>
            </div>
        </div>
...
$(document).ready(function() {
    ...
    $('#editproduct').on('submit', function(event){
        ...
        $.ajax({
            url:"{{ URL::to('user/product/update') }}",
            method:'POST',
            data:form_data,
            cache: false,
            contentType: false,
    ...
    function(isConfirm) {
        if (isConfirm) {
            $.ajax({
                ...
                url:"{{ URL::to('user/product/status') }}",
                data: {
                    id: id,
                    status: status
                },

                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" multiple="true" class="form-control" name="file[]" id="file" accept=".png, .jpg, .jpeg, .pdf">
                        </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#addproduct').on('submit', function(event){
            ...
            $.ajax({
                ...
                url:"{{ URL::to('admin/product/storeimages') }}",
                method:"POST",
                data:form_data,
                cache: false,
                contentType: false,
        ...
        $('#editimg').on('submit', function(event){
            ...
            var form_data = new FormData(this);
            $.ajax({
                url:"{{ URL::to('admin/product/updateimage') }}",
                method:'POST',
                data:form_data,
                cache: false,
                contentType: false,
    ...
    function EditDocument(id) {
        $.ajax({
            ...
            url:"{{ URL::to('admin/product/showimage') }}",
            data: {
                id: id
            },
        ...
        function(isConfirm) {
            if (isConfirm) {
                $.ajax({
                    ...
                    url:"{{ URL::to('admin/product/destroyimage') }}",
                    data: {
                        id: id
                    },
                    method: 'POST',
